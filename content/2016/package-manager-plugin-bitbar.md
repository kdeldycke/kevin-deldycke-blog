...
![Earlier version of the same dropdown, showing only the six outdated Homebrew packages and three Cask packages]({attach}package_manager_plugin_bitbar_v1_screenshot.png)
