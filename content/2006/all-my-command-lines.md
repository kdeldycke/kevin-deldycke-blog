...
![Raked close-up of a monitor showing a terminal cloning the scripts repository from GitHub, followed by a find command listing dated Python and PHP scripts](command-lines.jpg)
...
- [Archives]({filename}/2006/archives-commands.md)
...
- [Audio]({filename}/2006/audio-commands.md)
- [Image Processing]({filename}/2006/image-processing-commands.md)
- [Text, Date & Document Processing]({filename}/2006/text-date-document-processing-commands.md)
- [dpkg, APT & Aptitude]({filename}/2008/dpkg-apt-aptitude-commands.md)
- [RPM, Urpmi & Yum]({filename}/2006/rpm-urpmi-yum-commands.md)
- [OpenSSH]({filename}/2010/openssh-commands.md)
...
- [Exim]({filename}/2010/exim-commands.md)
