...
![Diagram of two parallel commit chains labelled SVN and Git, with curved arrows showing the Git history grafted back onto the SVN trunk at two revisions]({attach}git-svn-parallel-branches.png)
