...
![OpenERP timesheet search with hand-drawn red rings around the single Date from field and the date-from and date-to columns it has to match](openerp-61-no-range-search-widget.png)
