...
![GitLab network view with the orphan branch label sitting on a temporary initial commit, detached above the develop branch and its chain of history](gitlab-network-view-orphan-branch.png)
