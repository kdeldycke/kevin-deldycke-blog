...
![Frame from the animation: rounded white blobs on black, merging and splitting like the wax in a lava lamp squeezed into a square]({attach}squared-lave-lamp-preview.png)
...
![Quartz Composer scan-lines patch, the Sunbeams output passed through an eightfold reflected tile, a crop and a hatched screen before the billboard]({attach}sharp-scan-lines-patch.png)
...
![The lava-lamp variant of the same patch, with an Edge Work patch in place of the hatched screen]({attach}squared-lava-lamp-patch.png)
