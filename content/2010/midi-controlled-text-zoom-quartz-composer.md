...
![Behringer BCF-2000 control surface next to a MacBook Pro displaying the words Hello World, a plasma ball glowing between them](midi-controller-preview.jpg)
...
![Quartz Composer patch with a MIDI controllers receiver on the left, its outputs multiplied and smoothed before driving the colour and the position, rotation and size of a text sprite](patch-of-midi-controlled-text-zoom-in-quartz-composer.png)
