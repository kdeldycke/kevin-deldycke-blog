...
![Short Quartz Composer patch running an image through a colour invert and a bloom whose radius is driven by an LFO, then out to a billboard](glowing-cool-cavemen-patch.png)
