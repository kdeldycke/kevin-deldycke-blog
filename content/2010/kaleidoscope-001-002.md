...
![Frame from the animation: overlapping white and pale blue star shapes radiating from two bright cyan points, layered into a kaleidoscope](kaleidoscope-preview.jpg)
...
![Quartz Composer patch for the first kaleidoscope, a colour wheel and three LFOs driving a Sunbeams patch through an eightfold reflected tile, a crop and a billboard](kaleidoscope-001-patch.png)
...
![The second version of the same patch, with a CMYK halftone inserted between the crop and the billboard](kaleidoscope-002-patch.png)
