...
01. Setup [SMART]({filename}/2011/setting-hdds-smart-monitoring-debian-squeeze.md) monitoring tool for HDDs.

02. Setup [Nut]({filename}/2011/mge-ellipse-750-ups-debian-squeeze.md) to manage the UPS.

03. Setup [Duplicity and Amazon S3]({filename}/2011/cloud-based-server-backups-duplicity-amazon-s3.md) for cloud-based backups.

04. Setup [Exim]({filename}/2011/how-to-gmail-send-mails-debian-squeeze.md) to relay mails via Gmail.

05. Setup [cron-apt]({filename}/2011/fresh-debian-thanks-to-cron-apt.md) to keep our distribution up to date.

06. Add a [fail2ban]({filename}/2011/configuring-fail2ban-debian-squeeze.md) daemon.

07. Setup [Munin]({filename}/2011/munin-monitor-debian-squeeze-server.md) to monitor our machine.

08. [Basic setup of Nginx + PHP-FPM + MySQL]({filename}/2011/nginx-php-fpm-mysql-debian-squeeze-server.md) web stack.

09. [Optimizing Nginx + PHP-FPM + MySQL]({filename}/2011/nginx-php-fpm-mysql-configuration.md) for performances.
