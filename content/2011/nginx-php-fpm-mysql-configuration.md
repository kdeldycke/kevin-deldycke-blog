...
![OVH virtual private server order page with tier 3 picked on the slider: four vCores at 1.5 GHz, 1 GB of memory, 50 GB of storage and a 99.99% SLA](ovh-vps-3-virtual-server.png)
