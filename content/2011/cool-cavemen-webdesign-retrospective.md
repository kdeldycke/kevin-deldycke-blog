...
![Early e107 forum theme titled The Ultimate Band, its header a green laser burst on black above lime-green forum tables]({attach}2004_11_13.png)
...
![The Ultimate Band theme reworked in warm sand tones, the header now an orange laser flare and the sidebar moved to the right]({attach}2004_11_28.png)
...
![Theme renamed Cool Cavemen, its header a sepia photo of the band's first gig with only three musicians on stage]({attach}2005_01_021.png)
...
![Theme built around the first official band photo of all five members, tinted orange, with a leopard-fur strip running down the right column]({attach}2005_02_27.png)
...
![Three-column fluid layout test, an Eric Meyer quote about frustration, hardship and endless reward pinned top right]({attach}2005_03_06.png)

![Second three-column layout test, the right column given over to a note crediting the Skidoo Too Gargoyles template]({attach}2005_04_01.png)
...
![September 2005 theme with the band photo fading into grey, and an All Cool Hits box at the top of the right column scheduling one track release per week]({attach}2005_09_06.png)
...
![First reboot proposal, a dusk-gradient header with the band's heads silhouetted along the horizon]({attach}new_look_11.png)

![Second reboot proposal, the five faces peering over a strip of ground against the same dusk sky, with blue table headers]({attach}new_look_2.png)

![Third reboot proposal, heads emerging from a deeper blue and gold sunset]({attach}new_look_3.png)

The last one had an interactive header, with tiny sketches showing up on mouse
over:

![The same header on mouse over, with hand-drawn doodles sprouting from each face: a banana, glasses, devil horns and sound waves]({attach}new_look_3_mouseover.png)
...
![Final e107 theme for the Raw EP, the band photo pushed to high-contrast halftone beside a stencilled Cool Cavemen logo]({attach}coolcavemen.png)

Then I switched to WordPress:

![WordPress site on a K2 theme, its red banner announcing the Raw EP with a play button and the artwork pinned up like a photo]({attach}cool-cavemen-2008-raw-ep-k2-theme.png)
