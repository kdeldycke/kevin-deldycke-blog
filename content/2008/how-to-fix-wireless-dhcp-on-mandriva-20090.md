...
![Mandriva wireless configuration in French, the network settings dialog open on the DHCP client dropdown with dhcpcd picked over dhclient, pump and dhcpxd](mandriva-net-applet-wireless-dhcp.png)
